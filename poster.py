...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def _set_response(self):
        ...
        self.wfile.write(bytes("<p><a href=http://"+ip+":8000/?cmd=1"">Fade Up Current Poster</a></p>", "utf-8"))        
        ...
        if "?" in self.path :
           ...
           if "poster" in query:
              if query['poster'][0] != posterTex:
                ...
                sprite1 = pi3d.ImageSprite("./"+posterTex,shader=shader,w=DISPLAY.height, h=DISPLAY.width, z=z1)
                if a1 <= 0:
